      ...
      container.innerHTML = `
        <div class="ip-step">
          <div class="ip-step__row">
            ...
            <button class="equip-btn btn equip-btn--primary" type="button" data-action="md-mod-open">
        ...
        <div class="ip-modal" data-md-modal aria-hidden="true">
          ...
          <div class="ip-modal__dialog" role="dialog" aria-modal="true" aria-label="Adicionar Módulo">
            ...
            <div class="ip-modal__foot">
              <button class="create-equip__btn btn create-equip__btn--ghost" type="button" data-md-close>Cancelar</button>
              <button class="create-equip__btn btn create-equip__btn--primary" type="button" data-action="md-mod-add">Adicionar</button>
            </div>
          </div>
        </div>
      `;
          ...
          <div class="equip-page">
            ...
            <div class="mod-panel card">
              <div class="mod-panel__head">
                ...
                <button class="mod-panel__danger btn" type="button" data-action="md-mod-del-first">
